      ...
      <main className="max-w-7xl mx-auto p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-gray-600">
                Manage and track student mobility applications and statistics
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <TableBody>
                          {outgoingStudents.map((student) => (
                            <TableRow key={student.id}>
                              ...
                              <TableCell>
                                <Badge
                                  className={statusConfig[student.status].color}
                                >
                        ...
                        <TableBody>
                          {incomingStudents.map((student) => (
                            <TableRow key={student.id}>
                              ...
                              <TableCell>{student.hostDepartment}</TableCell>
                              <TableCell>
                                <Badge
                                  className={statusConfig[student.status].color}
                                >
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Erasmus Coordinators</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-sm">Dr. Ana Petrović</p>
                      <p className="text-xs text-gray-500">
