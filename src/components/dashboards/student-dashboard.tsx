          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-gray-600">
                Track your Erasmus+ internship applications, documentation, and
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Internship opportunities matching your profile and interests
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="space-y-4">
              ...
              {mockApplications.map((application) => (
                <ApplicationCard
                  ...
                  onViewDetails={() => setSelectedApplication(application.id)}
                />
              ))}
            </div>
