...
export function CareerOfficeDashboard() {
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription>
                        Create and manage Career Day and Speed Networking events
                      </CardDescription>
                    </div>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>6-month platform statistics</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      ...
                      <div className="text-center p-4 bg-green-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">Employer Growth</p>
                      </div>
                    ...
                    <div className="border rounded-lg p-4">
                      <h4 className="font-semibold mb-4">Monthly Statistics</h4>
                      <div className="space-y-3">
